...
import org.source.controllers.HistoryOrdersPanelController;
import org.source.models.Order;
import org.source.service.CacheService;
import org.source.views.base.BasePanel;

public class HistoryOrdersPanel extends BasePanel {
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(object == m_searchButton) {
			...
			HistoryOrdersPanelController.getInstance().search(this, 
			...
			HistoryOrdersPanelController.getInstance().description();
		} else if(object == m_saveButton) {
			HistoryOrdersPanelController.getInstance().save();
		} else if(object == m_backButton) {
			HistoryOrdersPanelController.getInstance().back();
		}
	}
	@Override
