...
public class User {
	...
	final public static int ACCESS_GUEST = 0;
	final public static int ACCESS_ADMIN = 6;
	final public static int ACCESS_CLIENT = 1;
	final public static int ACCESS_EMPLOYEE = 2;
	...
	public User(int id, String login, int numberOrders, int summOrders) {
		m_id = id;
		m_login = login;
		m_pass = "";
		m_access = 0;
	...
	public User(int id, String login, String sName, String fName, String mName, String email) {
		m_id = id;
		m_login = login;
		m_pass = "";
		m_access = 0;
	...
	public boolean equals(Object user) {
		...
		if(user instanceof User) {
			if(this.m_id != ((User)user).m_id) return false;
		} else return false;
		return true;
	}
